...
Karewa terraces are a geological formation characterized by alternating layers formed through rain-induced erosion.
...
To measure the condition of the land covers within each terrace, I used a new metric I'm playing with that was bare-earth fraction, which was the percentage of the pixels within a given polygon that were below an NDVI threshold that I thought represented bare ground. It was calculated from each season-matched (i.e., June, July, August, September) composite in the years 1994 (based on Landsat 5 data), 2005 (based on Landsat 5 data), 2015 (based on Landsat 8 data), and 2025 (based on Sentinel-2 data). Terraces that degraded by 15% or more of bare earth between 1994 and 2025 were likely degraded, and received this label.
